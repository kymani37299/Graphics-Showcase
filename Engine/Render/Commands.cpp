...
namespace GFX::Cmd
{
	...
	{
		PROFILE_CMD();
		GFX::Cmd::TransitionResource(context, argumentBuffer, D3D12_RESOURCE_STATE_INDIRECT_ARGUMENT);
		if(countBuffer) GFX::Cmd::TransitionResource(context, countBuffer, D3D12_RESOURCE_STATE_INDIRECT_ARGUMENT);
